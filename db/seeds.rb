...
shelter5 = Shelter.new(name: "Green Dog Rescue", location: Faker::Address.street_name, capacity: 4, logo: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523158/uoitcvz6n0nuvl1y7vgk.png", banner: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708528064/jfusq321ky7gw7n617o8.jpg", description: "Welcome to Green Dog Rescue, where every dog finds their purrfect paradise. Our shelter specializes in rescuing and rehoming canine friends, providing a safe and nurturing environment for dogs of all ages and backgrounds. Whether you're looking for a playful puppy or a mellow senior, we have the perfect companion waiting for you.")
shelter5.user = go
shelter5.save

shelter6 = Shelter.new(name: "Pet Pal Animal Shelter", location: Faker::Address.street_name, capacity: 4, logo: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523158/oztobfft3epus9kv7hue.png", banner: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708528064/hzkha1a6tbkm2hrzpcnp.jpg", description: "Welcome to Pet Pal Animal Shelter, where dogs wag their tails and cats purr with contentment. Our shelter is a haven for both canine and feline companions, providing a loving environment for all. Whether you're a dog lover or a cat enthusiast, you'll find your perfect match here. Join us in our mission to give every paw and whisker a forever home filled with love and happiness.")
shelter6.user = hellen
shelter6.save

puts "Creating pets..."
dog1 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523162/sj0ict7cozranxmy72g5.png")
dog1.shelter = shelter1
dog1.save

dog2 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523161/r9w9abl698tni19g0fdh.png")
dog2.shelter = shelter02
dog2.save

dog3 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523158/h2q5hkyokczy6nzjlavf.jpg")
dog3.shelter = shelter3
dog3.save

dog4 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523160/h3tygp1u2fe7wezegulw.png")
dog4.shelter = shelter4
dog4.save

dog5 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523160/inesjl820vikdkkqjgjg.png")
dog5.shelter = shelter3
dog5.save

dog6 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523161/mmbdr7fatvoxq0fmjfsf.png")
dog6.shelter = shelter1
dog6.save

dog7 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523160/h6vg9pur5z4jonlmujvz.png")
dog7.shelter = shelter3
dog7.save

dog8 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708525944/tamas-pap-kA967nN0jAA-unsplash_cjvwkr.jpg")
dog8.shelter = shelter02
dog8.save

dog9 = Pet.new(name: Faker::FunnyName.name, species: "dog", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708525944/stephen-andrews-lEe3-hTg4Vg-unsplash_ohmeiu.jpg")
dog9.shelter = shelter3
dog9.save

cat1 = Pet.new(name: Faker::FunnyName.name, species: "cat", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708525599/Untitled_23_jqjbnl.png")
cat1.shelter = shelter1
cat1.save

cat2 = Pet.new(name: Faker::FunnyName.name, species: "cat", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523162/qtittjzx2noomkzecibk.png")
cat2.shelter = shelter02
cat2.save

cat3 = Pet.new(name: Faker::FunnyName.name, species: "cat", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523161/ma48ritiri5x1zfkprt5.png")
cat3.shelter = shelter4
cat3.save

cat4 = Pet.new(name: Faker::FunnyName.name, species: "cat", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523159/dog9qgug4qql5x2zhvt5.png")
cat4.shelter = shelter4
cat4.save

cat5 = Pet.new(name: Faker::FunnyName.name, species: "cat", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708523159/rdrkweqyoepjsaueoyux.png")
cat5.shelter = shelter3
cat5.save

cat6 = Pet.new(name: Faker::FunnyName.name, species: "cat", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708525945/svklimkin-XMxn_NkvnR0-unsplash_zlj3rr.jpg")
cat6.shelter = shelter1
cat6.save

cat7 = Pet.new(name: Faker::FunnyName.name, species: "cat", image: "https://res.cloudinary.com/dyqkwf9t6/image/upload/v1708525945/dan-wayman-Kc_4NutJIV4-unsplash_ucuo6j.jpg")
